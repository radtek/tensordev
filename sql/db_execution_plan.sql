-- -----------------------------------------------------------------------------------
-- File Name    : db_execution_plan.sql
-- Description  : Displays a tree-style execution plan of the specified statement after 
--                it has been explained
-- Requirements : Access to the DBA views.
-- Call Syntax  : @db_execution_plan.sql
...
FROM   plan_table pt
START WITH pt.id = 0
  AND pt.statement_id = '&statement_id'

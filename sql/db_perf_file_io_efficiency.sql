-- -----------------------------------------------------------------------------------
-- File Name    : db_perf_file_io_efficiency.sql
-- Description  : This script produces a cumulative report that gives information 
...
-- Call Syntax  : @db_perf_file_io_efficiency.sql

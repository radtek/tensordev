-- -----------------------------------------------------------------------------------
-- File Name    : db_sec_default_passwords.sql
-- Description  : Checks Oracle created users that still have their default password
-- Requirements : Access to the DBA views.
-- Call Syntax  : @db_sec_default_passwords.sql

-- -----------------------------------------------------------------------------------
-- File Name    : asm_files.sql
-- Description  : Provide a summary report of all files (and file metadata) information 
--                for all ASM disk groups.
-- Requirements : Access to the DBA views.
-- Call Syntax  : @asm_files.sql
...
COLUMN full_alias_path        FORMAT a73                    HEAD 'File Name'
COLUMN system_created         FORMAT a8                     HEAD 'System|Created?'
COLUMN bytes                  FORMAT "999G999G999G999G999"  HEAD 'Bytes'
COLUMN space                  FORMAT "999G999G999G999G999"  HEAD 'Space'

...
-- Description  : Provide a list of all AWR snapshots and the total database time
--               (DB Time) consumed within its interval. 
-- Requirements : Access to the DBA views.
-- Call Syntax  : @awr_snapshots_dbtime.sql
-- Last Modified: 09/04/2012
-- -----------------------------------------------------------------------------------

PROMPT This script will generate a log file called awr_snapshots_dbtime.log at /temp directory
SET TERMOUT OFF;
...
DEFINE spool_file=/tmp/awr_snapshots_dbtime.log

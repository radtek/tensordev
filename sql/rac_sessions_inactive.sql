-- -----------------------------------------------------------------------------------
-- File Name    : rac_sessions_inactive.sql
-- Description  : Displays information on all inactive database sessions for the whole 
--                RAC
-- Requirements : Access to the DBA views.
-- Call Syntax  : @rac_sessions_inactive.sql

-- -----------------------------------------------------------------------------------
-- File Name    : db_perf_hit_ratio_by_session.sql
-- Description  : Reports on all sessions along with their individual hit ratio.
-- Requirements : Access to the DBA views.
-- Call Syntax  : @db_perf_hit_ratio_by_session.sql

-- -----------------------------------------------------------------------------------
-- File Name    : tbs_estimated_growth_02.sql
-- Description  : This script shows the growth analysis of all tablespaces in the database
-- Requirements : Access to the DBA views.
-- Call Syntax  : @tbs_estimated_growth_02

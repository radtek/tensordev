-- -----------------------------------------------------------------------------------
-- File Name    : exadata_smart_incremental_backup.sql
-- Description  : This query shows the operations that resulted in the cell smart  
--                incremental backup wait event
-- Requirements : Access to the DBA views.
-- Call Syntax  : @exadata_smart_incremental_backup.sql
...
from (select sql_id, event, sql_plan_operation||' '||sql_plan_options operation
	  ...
	  where event like 'cell smart incremental%')

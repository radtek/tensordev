-- -----------------------------------------------------------------------------------
-- File Name    : db_perf_top_sql_by_buffer_gets.sql
-- Description  : Report on top SQL statements ordered by most buffer gets.
-- Requirements : Access to the DBA views.
-- Call Syntax  : @db_perf_top_sql_by_buffer_gets.sql
